...
class _AccountApi implements AccountApi {
  ...
  Future<ApiResponse<UserAddresses>> getUserAddresses() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiResponse<UserAddresses>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/user/addresses',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResponse<UserAddresses> _value;
    try {
      _value = ApiResponse<UserAddresses>.fromJson(
        _result.data!,
        (json) => UserAddresses.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
  ...
  @override
  Future<ApiResponse<UserAddressDetail>> getUserAddress(int id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiResponse<UserAddressDetail>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/user/addresses/${id}',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResponse<UserAddressDetail> _value;
    try {
      _value = ApiResponse<UserAddressDetail>.fromJson(
        _result.data!,
